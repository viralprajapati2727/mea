        ...
        <div class="page-header page-header-light">
            <div class="header-elements-md-inline job-list-header my-job-list-header">
                ...
                <div class="job-header-elements d-sm-flex">
                    <a href="{{ route('start-statup-portal') }}" class="btn-primary jb_btn jb_nav_btn_link post-job-btn"><i class="flaticon-business-idea"></i>Create new Startup </a>
                </div>
            </div>
        </div>
        <!-- Content area -->
                                    ...
                                    <div class="list-icons">
                                        <div class="list-icons-item dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right jb_company_dropdown_nav" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(30px, 30px, 0px);">
                                                {{-- <a href="{{ route('job.view-applicant',['job_unique_id' => $startup->id]) }}" class="dropdown-item"><span class="main-icon-span"><i class="flaticon-user"></i></span>View Startup Portal Details</a> --}}
                                                <a href="{{ route('start-statup-portal',['portal_id' => $startup->id]) }}" class="dropdown-item"><span class="main-icon-span"><i class="flaticon-edit"></i></span> Edit Portal</a>
